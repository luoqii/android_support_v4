...
import static org.bangbang.support.v4.app.DownloadManager.COLUMN_LOCAL_FILENAME;
import static org.bangbang.support.v4.app.DownloadManager.COLUMN_LOCAL_URI;
import static org.bangbang.support.v4.app.DownloadManager.COLUMN_MEDIA_TYPE;
import static org.bangbang.support.v4.app.DownloadManager.COLUMN_URI;

import org.bangbang.support.v4.provider.Downloads;
import org.bangbang.support.v4.provider.Downloads.Impl.RequestHeaders;
...
/**
 * copied from 
 * https://raw.github.com/android/platform_packages_providers_downloadprovider/android-4.2_r1/src/com/android/providers/downloads/OpenHelper.java
...
//                intent.putExtra(Intent.EXTRA_ORIGINATING_UID, getOriginatingUid(context, id));
                ...
                intent.setDataAndType(
                        ContentUris.withAppendedId(Downloads.Impl.ALL_DOWNLOADS_CONTENT_URI, id), mimeType);
            } else {
                intent.setDataAndType(localUri, mimeType);
            }
