...
//                    sel.offsetTopAndBottom(childrenLeft - sel.getTop());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.AT_MOST) {
            ...
            widthSize = measureHeightOfChildren(heightMeasureSpec, 0, NO_POSITION, widthSize, -1);
        }
     ...
     * @param maxWidth The maximum height that will be returned (if all the
     ...
     */
    final int measureHeightOfChildren(int heightMeasureSpec, int startPosition, int endPosition,
